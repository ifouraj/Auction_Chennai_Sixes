...
function result(teamAId: TeamId, teamBId: TeamId, winnerTeamId: TeamId, seed: number): MatchResult {
  ...
  return {
    ...
    firstInnings: { teamId: teamAId, runs: 50, wickets: 2, balls: 30, overs: '5.0' },
    secondInnings: { teamId: teamBId, runs: winnerTeamId === teamBId ? 51 : 45, wickets: 3, balls: 30, overs: '5.0' },
    winnerTeamId,
    loserTeamId,
